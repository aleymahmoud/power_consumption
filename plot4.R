...
plot(hpc_feb_2007$Time,hpc_feb_2007$Global_active_power,type="l",xlab="",
     ylab="Global active power")

plot(hpc_feb_2007$Time,hpc_feb_2007$Voltage,type="l",xlab="",
     ylab="Voltage")

plot(hpc_feb_2007$Time,hpc_feb_2007$Sub_metering_1,type="n",xlab="",ylab="Energy sub metering")
with(hpc_feb_2007,lines(Time,Sub_metering_1,col="black"))
with(hpc_feb_2007,lines(Time,Sub_metering_2,col="red"))
with(hpc_feb_2007,lines(Time,Sub_metering_3,col="blue"))
legend(x = "topright", lty=1, col=c("black","red","blue"),
       legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),cex = 0.55)

plot(hpc_feb_2007$Time,hpc_feb_2007$Global_reactive_power,type="l",xlab="",
